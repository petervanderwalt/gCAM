        ...
        case 2:
            ...
            for (var i = 0; i < post.numberOfGlyphs; i++) {
                if (post.glyphNameIndex[i] < standardNames.length) {
                    ...
                    this.names[i] =
                        post.names[
                            post.glyphNameIndex[i] - standardNames.length
                        ];
                }
            }
                        ...
                        return new table.Table(
                            ...
                            table.tableList(
                                ...
                                function (chainRule) {
                                    ...
                                    chainRule.lookupRecords.forEach(
                                        function (record, i) {
                                            tableData = tableData
                                                .concat({
        ...
        for (var j = 0; j < subtables.length; j++) {
            ...
            switch (subtable.posFormat) {
                ...
                case 2:
                    ...
                    var class1 = this.getGlyphClass(
                        subtable.classDef1,
                        leftIndex,
                    );
                    var class2 = this.getGlyphClass(
                        subtable.classDef2,
                        rightIndex,
                    );
                ...
                if (component.matchedPoints === undefined) {
                    ...
                    if (
                        ...
                        component.matchedPoints[1] >
                            componentGlyph.points.length - 1
                    ) {
                        throw Error(
